...
const Navbar = ({homeRedirect, children}) => {
  return (
    <nav className='w-full h-[10vh] border-b-8 border-black bg-gray-700 flex flex-row items-center text-white pl-6 nav-fade-in'>
      <a href={homeRedirect} onClick={()=>{sessionStorage.clear();}} className='text-2xl'>Home</a>
      <div className='w-1 h-[10vh] bg-gray-800 ml-7'></div>
